...
Deno.test({
  ...
  async fn() {
    ...
    assertEquals(graph, {
      ...
      "https://cdn.skypack.dev/three": [
        {
          "input": "https://cdn.skypack.dev/three",
          "output":
            "dist/deps/16828907cebaf18c3d11ca992119640ca8d227387b33f2014545d47bcd649c5b.js",
          "dependencies": {
            "https://cdn.skypack.dev/-/three@v0.129.0-tccbvW7qPaDqcjcm1Rsy/dist=es2020,mode=imports/optimized/three.js":
              {
                "Import": {
                  "namespaces": [
                    "*",
        ...
        [
          {
            "input":
              "https://cdn.skypack.dev/-/three@v0.129.0-tccbvW7qPaDqcjcm1Rsy/dist=es2020,mode=imports/optimized/three.js",
            "output":
              "dist/deps/77d96eab8f70406d14ed992dbc82832dc3e4a9dc3abe58d41c873846187e7c79.js",
            "dependencies": {},
            "export": {
              "specifiers": {

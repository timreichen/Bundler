...
export type Plugin = (path: string, source: string) => any

export function plugin({ name, include, exclude, transform }: { name: string, include?: Include, exclude?: Exclude, transform: Transform }): Plugin {

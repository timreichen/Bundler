import { colors, ts, xts } from "./deps.ts";
...
export function isDynamicImportNode(node: xts.Node): node is ts.CallExpression {
  return node.kind === xts.SyntaxKind.CallExpression &&
    node.expression.kind === xts.SyntaxKind.ImportKeyword;
}
export function getDynamicImportNode(node: ts.CallExpression, source: string) {
